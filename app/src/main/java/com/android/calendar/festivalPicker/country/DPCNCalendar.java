...
import com.android.calendar.festivalPicker.bizs.SolarTerm;
...
/**
 * 中国月历，继承自DPCalendar，里面新增中国节日相关的方法
 *
 * Calendar of China
 *
 * @author AigeStudio 2015-06-16
 */
public class DPCNCalendar extends DPCommonFestival{
    //公历
    ...
    private static final String[][] FESTIVAL_G = {//公历节日
            {"元旦"},
            {"世界湿地日", "情人节"},
    ...
    private static final String[][] FESTIVAL_L = {//农历节日
            {"春节", "元宵节"},
            {},
            {},
            {"清明节"},
    ...
    private static final String[][] HOLIDAY = {//假日
            {"2", "3"},
    ...
    private String[][] buildMonthL(int year, int month) {
        String[][] gregorianMonth = buildMonthG(year, month);//[0-31]
        G g = new G();
