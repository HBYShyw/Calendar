...
//        SearchView.OnCloseListener {
    ...
    public void ContinueOnCreateEventInfo() {
        ...
        if (mBundleIcicleOncreate != null) {
            ...
            attendeeResponse = mBundleIcicleOncreate.getInt(EventInfoFragment.BUNDLE_KEY_ATTENDEE_RESPONSE);
        ...
        if (bar != null) {
            ...
            //actionBar.setDisplayHomeAsUpEnabled(true)�����Ͻ�ͼ�����߼���һ�����ص�ͼ�ꡣ
            // ��ӦActionBar.DISPLAY_HOME_AS_UP
            //actionBar.setDisplayShowHomeEnabled(true)ʹ���Ͻ�ͼ��ɵ��
            //��ӦidΪandroid.R.id.home����ӦActionBar.DISPLAY_SHOW_HOME
        }
