package com.android.calendar.customPlug;
...
public class FloatingActionButton extends View {
	...
	public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColor = a.getColor(R.styleable.FloatingActionButton_float_color,Color.TRANSPARENT);
    ...
    public int getmLeftDisplayed(){
        return mLeftDisplayed;
    }

    public int getmTopDisplayed(){
        return mTopDisplayed;
    }
}
