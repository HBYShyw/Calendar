...
public class CalendarEventModel implements Serializable {
    ...
    public static class Attendee implements Serializable {
        ...
        /**
         * M: get attendee address as MTKRecipientEditTextView needed.
         */
        public String getRecipientAddress() {
            ...
            String simpleName = mName;
            if (TextUtils.isEmpty(simpleName) || mEmail.equals(simpleName)) {
                int index = mEmail.indexOf("@");
                if (index != -1) {
                    simpleName = mEmail.substring(0, index);
                }
            }
            address = simpleName + " <" + mEmail + ">";
            return address;
        }
    }
    ...
    // list and will instead be added by saveEvent. Islamic this what we want?
