        ...
        if (mShowDate) {
            ...
            switch (mCurrentMainView) {
                case ViewType.DAY:
                    ...
                    weekDay.setText(buildDayOfWeek());//显示上面的星期几
